...
if __name__ == '__main__':
    ...
    # state_all_df.to_csv(fold + 'state_kdj_macd_future' + '.csv')
    # signal_all_df.to_csv(fold + 'signal_kdj_macd_future' + '.csv')
    signal_all_df = pd.read_csv(fold + 'signal_kdj_macd_idx_l_0adj.csv')
    state_all_df = pd.read_csv(fold + 'state_kdj_macd_idx_ls_0.csv')
    ...
    ret.to_csv(fold + 'winr_odds_kdj_macd_' + 'stock_l_adj.csv')
    sharp = pd.read_csv(fold + 'sharp_kdj_macd_' + 'stock_ladj.csv')
    sharp = sharp.merge(ret, on=['buy1', 'buy2', 'sell1', 'sell2', 'method', 'percentile'])
    sharp.to_csv(fold + 'state_kdj_macd_stock_l_adj.csv')
