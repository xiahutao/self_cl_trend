...
if __name__ == '__main__':
                                ...
                                for K2 in K2_lst:
                                    for ATR_n in ATR_n_lst:
                                        ...
                                        for idx, _row in group_.iterrows():
                                            if pos == 0:
                                                if (_row.long_ratio > K2) & ((_row.low - _row.LL_s) < (
                                                        _row.HH_s - _row.LL_s) * (0.5 - 0.5 * K1)):
                                                    cost = ((0.5 - 0.5 * K1) * (_row.HH_s - _row.LL_s) + _row.LL_s) * (
                                                            1 + fee)
                                                ...
                                                elif (_row.long_ratio < -K2) & ((_row.high - _row.LL_s) > (
                                                        _row.HH_s - _row.LL_s) * (0.5 + 0.5 * K1)):
                                                    cost = ((0.5 + 0.5 * K1) * (
                                                    ...
                                                    net = net
                                            if pos > 0:
                                                if (_row.long_ratio < -K2) & ((_row.high - _row.LL_s) > (
                                                        _row.HH_s - _row.LL_s) * (0.5 + 0.5 * K1)):
                                                    s_price = ((0.5 + 0.5 * K1) * (
                                                            _row.HH_s - _row.LL_s) + _row.LL_s) * (1 - fee)
                                                    if _row.open > (0.5 + 0.5 * K1) * (
                                    ...
                                    # plt.show()
                                    # pd.DataFrame({'net': net_lst}).to_csv('E:/data/' + 'net' + symble + '.csv')
    ...
    print(signal_state)
    signal_state.to_csv('E:/data/' + 'state_ocm_yee_' + symble + '.csv')
