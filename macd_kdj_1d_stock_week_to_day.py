...
if __name__ == '__main__':
    ...
    #                   '601111.XSHG', '000002.XSHE', '002739.XSHE']
    ...
    lst = []
    for method, group in signal_state_all_df.groupby(['buy1', 'buy2', 'sell1', 'sell2', 'method', 'percentile']):
        row = []
        ...
        lst.append(row)
    ret = pd.DataFrame(lst, columns=['buy1', 'buy2', 'sell1', 'sell2', 'method', 'percentile', 'winr', 'odds', 'ave_r', 'trading_times'])
    ret.to_csv(fold + 'kdj_macd_' + str(len(index_code_lst)) + '.csv')
