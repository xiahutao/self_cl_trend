...
if __name__ == '__main__':
    ...
    trd_idx_code_list = ['000989', '399550', 'H30165', '399364', '000036', '399973', '000066', '000068', '000048',
                         ...
                         '000932', '000056']
    trd_idx_code_list = ['000987', '000986']
    ...
    etf_to_idx = pd.read_excel(fold_data + 'etf_to_idx_indus.xls', encoding='gbk')[
    ...
    print('=========len(index_code_select_lst):', len(index_code_select_lst))
    index_code_lst = [i for i in index_code_select_lst if str(i)[:6] in trd_idx_code_list]
    print('=========len(index_code_lst):', len(index_code_lst))
