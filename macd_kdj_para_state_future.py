...
if __name__ == '__main__':
    ...
    signal_state_all_df = pd.read_csv(fold + 'state_kdj_macd_' + 'future_all.csv')
    ...
    title = '多空:不同参数'
    lst = []
    signal_state_all_df = signal_state_all_df[(signal_state_all_df['buy1'] == 20) & (signal_state_all_df['buy2'] == 30) &
